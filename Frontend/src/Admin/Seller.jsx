...
const Seller = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 min-h-screen">
      <Anavbar />
      <br />
      <h1 className="text-center text-white text-3xl font-extrabold">Vendors</h1>
      <br />
                                ...
                                return (
                                  ...
                                  >
                                    <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                                      <div>
                                        <img src={`http://localhost:4000/${item?.itemImage}`} alt={`${item.itemtype} Image`} style={{ height: "80px", width: "120px" }} />
                                      </div>
                                      <div>
                                        <p>Product Name:</p>
